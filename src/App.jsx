...
function App() {
    ...
    return (
        <AnimatePresence>
            <BrowserRouter>
                <main className="flex flex-col bg-lotrdle bg-center bg-fixed bg-no-repeat mx-auto py-5 font-middleEarth items-center text-primary-content min-h-[100svh] px-0 sm:px-[5vw] md:px-[10vw] lg:px-[20vw]">
                    <Header />
                    <Routes>
                        <Route
                            path="/"
